...
export class ParameterGenerator {
    ...
    private getFileParameter(parameter: ts.ParameterDeclaration, decoratorName: string): Parameter {
    ...
    private getFilesParameter(parameter: ts.ParameterDeclaration, decoratorName: string): Parameter {
        const { parameterName, name } = this.getNameAndParameterName(parameter, decoratorName);
    ...
    private getCookieParameter(parameter: ts.ParameterDeclaration, decoratorName: string): Parameter {
        const { parameterName, name } = this.getNameAndParameterName(parameter, decoratorName);
    ...
    private getHeaderParameter(parameter: ts.ParameterDeclaration, decoratorName: string): Parameter {
        const { parameterName, name } = this.getNameAndParameterName(parameter, decoratorName);
        const type = this.getValidatedType(parameter);
    ...
    private getQueryParameter(parameter: ts.ParameterDeclaration, decoratorName: string): Parameter {

        const { parameterName, name } = this.getNameAndParameterName(parameter, decoratorName);
        const parameterOptions = getDecoratorOptions(this.parameter, ident => ident.text === decoratorName) || {};
    ...
    private getPathParameter(parameter: ts.ParameterDeclaration, decoratorName: string): Parameter {
        const { parameterName, name } = this.getNameAndParameterName(parameter, decoratorName);
        const type = this.getValidatedType(parameter);
    ...
    private getNameAndParameterName(parameter: ts.ParameterDeclaration, decoratorName: string) {
        const parameterName = (parameter.name as ts.Identifier).text;
        const name = getDecoratorTextValue(this.parameter, ident => ident.text === decoratorName) || parameterName;

...
export declare type UsableDeclaration =
...
export declare function getEnumerateType(
  typeNode: ts.TypeNode
): EnumerateType | undefined;
export declare function getLiteralType(
  typeNode: ts.TypeNode
): EnumerateType | undefined;
...
export declare function createCircularDependencyResolver(
  typeName: string
): {
  description: string;
  properties: Property[];
...
export declare function getModelDescription(
  modelTypeDeclaration: UsableDeclaration
): string;
export declare function getNodeDescription(
  node: UsableDeclaration | ts.PropertyDeclaration | ts.ParameterDeclaration
): string;
export declare function resolveTypeArguments(
  node: ts.ClassDeclaration,
  typeArguments?: ReadonlyArray<ts.TypeNode>,
  parentTypeArguments?: Map<String, ts.TypeNode>
): Map<String, ts.TypeNode>;
export declare function buildGenericTypeMap(
  node: ts.ClassDeclaration,
  typeArguments?: ReadonlyArray<ts.TypeNode>
): Map<String, ts.TypeNode>;
export declare function getSubClassGenericTypes(
  genericTypeMap?: Map<String, ts.TypeNode>,
  typeArguments?: Array<ts.TypeNode>
): ts.TypeNode[];
export declare function mergeReferenceTypeProperties(
  properties: Property[],
  extendedProperties: Property[]
): void;
export declare function nodeIsUsable(node: ts.Node): boolean;
export declare function resolveLeftmostIdentifier(
  type: ts.EntityName
): ts.Identifier;
export declare function resolveModelTypeScope(
...
export declare function resolveTypeParameter(
  type: any,
